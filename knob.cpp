...
int main(void)
{
    ...
    // led1.Init(hardware.GetPin(23), false);
    ...
    for(;;)
    {
        ...
        int value_int = (int)(value * 1000); // Convert to millivolts or similar scale

        // hardware.PrintLine("%d",i);
        hardware.PrintLine("Fader Value: %d", value_int);
